...
async function main() {
  ...
  await prisma.event.create({
    data: {
      ...
      flyerUrl: 'https://res.cloudinary.com/lswvtj4t/image/upload/v1785010425/redes/events/ydgge1wqg2c7iqmx2ll8.jpg',
  ...
  await prisma.event.create({
    data: {
      ...
      address: '20 de Junio y Cotopaxi, Lago Agrio, Ecuador',
      flyerUrl: 'https://res.cloudinary.com/lswvtj4t/image/upload/v1785010430/redes/events/kur6uhks4ju0s1mh10ja.jpg',
      status: EventStatus.UPCOMING,
      isFeatured: true,
      capacity: 300,
      createdById: admin.id,
